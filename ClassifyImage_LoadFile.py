...
if not os.path.isdir('C:/Users/Username/Desktop/ImageClassify/output/NATIVES'):
    os.mkdir('C:/Users/Username/Desktop/ImageClassify/output/NATIVES')
#Create text directory in output dir
if not os.path.isdir('C:/Users/Username/Desktop/ImageClassify/output/TEXT'):
    os.mkdir('C:/Users/Username/Desktop/ImageClassify/output/TEXT')
...
conn = sqlite3.connect("C:\\Users\\Username\\Desktop\\ImageClassify\\output\\imageclassify.db")
c = conn.cursor()
def create():
	try:
...
for file in glob2.glob(sourcedir + "/**/*.*", recursive=True): 
	...
	outputtextdir = "C:\\Users\\Username\\Desktop\\ImageClassify\\output\\TEXT\\" 
	outputnativesdir = "C:\\Users\\Username\\Desktop\\ImageClassify\\output\\NATIVES\\" 
